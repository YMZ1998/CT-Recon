...
// selection
static const char* APPLY_TILT_CORR =
    "apply_tilted_axis_correction";  // 0 --> do not apply
// slope value
static const char* TILT_CORR_SLOPE_M = "slope_value_m_tilted_axis_correction";
// offset
static const char* TILT_CORR_CONST_C =
    "const_offset_value_tilted_axis_correction";
...
struct FDK_Parameters {
  ...
  float
      gpuMemoryUsage;  // how much of available graphic card memory will be used (%)
...
class Parameter {
 public:
  Parameter(char* parameterFile)
      : m_parameterFile(
            parameterFile) {  //-ju-09-Aug-2012 fallbacks to handle migration of parameter files (parameters are missing)
